...
export default function Contact() {
  return (
    <section id="contacto" className="py-28" style={{ backgroundColor: "var(--color-gessa-sand)", backgroundImage: "url('/imagenes/Recurso3.png')", backgroundRepeat: "no-repeat", backgroundSize: "contain" }}>
